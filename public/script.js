function getIframeWindow(a) {
  ...
  return a.contentWindow
    ...
    : (!b && a.contentDocument && (b = a.contentDocument),
      ...
      b && b.defaultView ? b.defaultView : b && b.parentWindow ? b.parentWindow : void 0);
}
if (
    ...
    return {
      postMessage: function (a, b, c) {
        if (b)
          ...
          } else b && (c.location = b.replace(/#.*$/, '') + '#' + +new Date() + d++ + '&' + a);
      },
          ...
          ? (d &&
              (c = function (a) {
                var b = e.location.search.split('?').join(''),
                  c = b.indexOf('offline_forms=true') > -1 || b.indexOf('offline_forms=si') > -1;
                return !c &&
                  (('string' == typeof f && a.origin !== f) ||
                    ('[object Function]' === Object.prototype.toString.call(f) && f(a.origin) === !1))
                  ? !1
                  : (d(a), void 0);
              }),
            e.addEventListener
              ? e[d ? 'addEventListener' : 'removeEventListener']('message', c, !1)
...
!(function (a, b) {
  ...
  function g() {
    ...
    if (((b.version = '2.2.0'), (b.removed = []), !a || !a.document || 9 !== a.document.nodeType)) return (b.isSupported = !1), b;
    var c = a.document,
      h = a.document,
    ...
    var gb = J,
      ...
      Pb = function (a) {
        (Nb && Nb === a) ||
          ((a && 'object' === ('undefined' == typeof a ? 'undefined' : Q(a))) || (a = {}),
          (a = e(a)),
      ...
      Sb = function (a) {
        ...
        if (!b || !b.documentElement) {
          ...
          var g = b,
            i = g.body;
          i.parentNode.removeChild(i.parentNode.firstElementChild), (i.outerHTML = e);
        }
        return (
          a && c && b.body.insertBefore(h.createTextNode(c), b.body.childNodes[0] || null), ab.call(b, xb ? 'html' : 'body')[0]
        );
      },
      Tb = function (a) {
        return _.call(
      ...
      Xb = function (a) {
        ...
        if (
          ...
          ('svg' === d || 'math' === d) && 0 !== a.querySelectorAll('p, br').length)
        )
          return Qb(a), !0;
        if (
        ...
        return ('noscript' !== d && 'noembed' !== d) || !y(/<\/no(script|embed)/i, a.innerHTML)
          ? (wb &&
              3 === a.nodeType &&
              ((c = a.textContent),
              (c = v(c, gb, ' ')),
              (c = v(c, hb, ' ')),
              a.textContent !== c && (s(b.removed, { element: a.cloneNode() }), (a.textContent = c))),
            Wb('afterSanitizeElements', a, null),
            !1)
          : (Qb(a), !0);
      },
      Yb = function (a, b, c) {
        if (Eb && ('id' === b || 'name' === b) && (c in h || c in Ob)) return !1;
        if (ub && y(ib, b));
        else if (tb && y(jb, b));
        else {
          ...
          else if (('src' !== b && 'xlink:href' !== b && 'href' !== b) || 'script' === a || 0 !== w(c, 'data:') || !Jb[a])
            if (vb && !y(kb, v(c, lb, '')));
            else if (c) return !1;
        }
        return !0;
      ...
      Zb = function (a) {
        ...
        var g = a.attributes;
        if (g) {
          var h = { attrName: '', attrValue: '', keepAttr: !0, allowedAttributes: pb };
          for (f = g.length; f--; ) {
            c = g[f];
            var i = c,
              j = i.name,
            ...
            if (
              ...
              if (y(/\/>/i, d)) Rb(j, a);
                ...
                if (Yb(l, e, d))
                  try {
                    k ? a.setAttributeNS(k, j, d) : a.setAttribute(j, d), r(b.removed);
                  } catch (m) {}
              }
          }
      ...
      $b = function _b(a) {
        ...
        for (Wb('beforeSanitizeShadowDOM', a, null); (b = c.nextNode()); )
          Wb('uponSanitizeShadowNode', b, null), Xb(b) || (b.content instanceof i && _b(b.content), Zb(b));
    ...
    return (
      (b.sanitize = function (d, e) {
        ...
        if ((d || (d = '<!-->'), 'string' != typeof d && !Vb(d))) {
          if ('function' != typeof d.toString) throw z('toString is not a function');
          if (((d = d.toString()), 'string' != typeof d)) throw z('dirty is not a string, aborting');
        }
        if (!b.isSupported) {
          if ('object' === Q(a.toStaticHTML) || 'function' == typeof a.toStaticHTML) {
            if ('string' == typeof d) return a.toStaticHTML(d);
            if (Vb(d)) return a.toStaticHTML(d.outerHTML);
          }
          return d;
        }
        if ((yb || Pb(e), (b.removed = []), 'string' == typeof d && (Gb = !1), Gb));
        else if (d instanceof l)
          (f = Sb('<!---->')),
            (g = f.ownerDocument.importNode(d, !0)),
            1 === g.nodeType && 'BODY' === g.nodeName ? (f = g) : 'HTML' === g.nodeName ? (f = g) : f.appendChild(g);
        else {
          if (!Ab && !wb && !xb && -1 === d.indexOf('<')) return X && Db ? X.createHTML(d) : d;
          if (((f = Sb(d)), !f)) return Ab ? null : Y;
        }
        f && zb && Qb(f.firstChild);
        for (var m = Tb(Gb ? d : f); (h = m.nextNode()); )
          (3 !== h.nodeType || h !== j) && (Xb(h) || (h.content instanceof i && $b(h.content), Zb(h), (j = h)));
        if (((j = null), Gb)) return d;
        if (Ab) {
          if (Bb) for (k = bb.call(f.ownerDocument); f.firstChild; ) k.appendChild(f.firstChild);
          else k = f;
          return Cb && (k = cb.call(c, k, !0)), k;
        }
        var n = xb ? f.outerHTML : f.innerHTML;
        return wb && ((n = v(n, gb, ' ')), (n = v(n, hb, ' '))), X && Db ? X.createHTML(n) : n;
      }),
  ...
  var q = b(Array.prototype.forEach),
    ...
    L = l(/^data-[\-\w.\u00B7-\uFFFF]/),
    M = l(/^aria-[\-\w]+$/),
    N = l(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),
    O = l(/^(?:\w+script|data):/i),
    P = l(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),
    Q =
    ...
    S = function (a, b) {
      if ('object' !== ('undefined' == typeof a ? 'undefined' : Q(a)) || 'function' != typeof a.createPolicy) return null;
      var c = null,
  ...
  (function () {
    ...
    function D(a, b) {
      (this.c = a), (this.f = b), (this.a = e(this.c, 'span', { 'aria-hidden': 'true' }, this.f));
    }
    function E(a) {
      f(a.c, 'body', a.a);
    }
    ...
    function I() {
      if (null === db) {
        ...
        db = !!a && (536 > parseInt(a[1], 10) || (536 === parseInt(a[1], 10) && 11 >= parseInt(a[2], 10)));
      }
      return db;
    }
    function J(a, b, c) {
      for (var d in cb) if (cb.hasOwnProperty(d) && b === a.f[cb[d]] && c === a.f[cb[d]]) return !0;
      return !1;
    }
    function K(a) {
      var b,
        c = a.g.a.offsetWidth,
        d = a.h.a.offsetWidth;
      (b = c === a.f.serif && d === a.f['sans-serif']) || (b = I() && J(a, c, d)),
        b
          ? ab() - a.A >= a.w
    ...
    function O(a) {
      0 == --a.f &&
        a.j &&
        (a.m
          ? ((a = a.a), a.g && h(a.f, [a.a.c('wf', 'active')], [a.a.c('wf', 'loading'), a.a.c('wf', 'inactive')]), A(a, 'active'))
          : z(a.a));
    }
    function P(a) {
          ...
          if (0 === d.length && g) z(b.a);
            ...
            for (j = 0; j < d.length; j++) {
              var l = d[j],
                ...
                o = l;
              if (
                (n.g && h(n.f, [n.a.c('wf', o.c, u(o).toString(), 'loading')]), A(n, 'fontloading', o), (n = null), null === eb)
              )
                if (window.FontFace) {
              ...
              (n = eb ? new G(c(b.g, b), c(b.h, b), b.c, l, b.s, m) : new H(c(b.g, b), c(b.h, b), b.c, l, b.s, a, m)), k.push(n);
            }
    ...
    function Y(a) {
      for (var b = a.f.length, c = 0; b > c; c++) {
        ...
        if (2 <= d.length) {
            ...
            for (var h = h.split(','), i = h.length, j = 0; i > j; j++) {
              ...
              if (((k = h[j]), k.match(/^[\w-]+$/))) {
                ...
                if (null == l) k = '';
                  ...
                  if (((k = l[2]), (k = null == k || '' == k ? 'n' : ib[k]), (l = l[1]), null == l || '' == l)) l = '4';
                  else
                    var m = hb[l],
          ...
          0 < g.length && (f = g),
            3 == d.length && ((d = d[2]), (g = []), (d = d ? d.split(',') : g), 0 < d.length && (d = gb[d[0]]) && (a.c[e] = d));
        }
        for (a.c[e] || ((d = gb[e]) && (a.c[e] = d)), d = 0; d < f.length; d += 1) a.a.push(new r(e, f[d]));
      }
    }
    function Z(a, b) {
      (this.c = a), (this.a = b);
    ...
    H.prototype.start = function () {
      (this.f.serif = this.j.a.offsetWidth), (this.f['sans-serif'] = this.m.a.offsetWidth), (this.A = ab()), K(this);
    };
    var eb = null;
    (N.prototype.g = function (a) {
      ...
      b.g &&
        h(
          ...
          [b.a.c('wf', a.c, u(a).toString(), 'loading'), b.a.c('wf', a.c, u(a).toString(), 'inactive')]
        ),
        A(b, 'fontactive', a),
        (this.m = !0),
        O(this);
            ...
            if (e)
              for (var h = 0; h < e.length; h++) {
                ...
                void 0 != e[h].fontStyle && void 0 != e[h].fontWeight
                  ? ((c = e[h].fontStyle + e[h].fontWeight), g.push(new r(i, c)))
                  : g.push(new r(i));
              }
            a(g);
          } else
      ...
      (T.prototype.load = function (a) {
        ...
        for (b = 0, c = e.length; c > b; b++)
          if (((d = e[b].split(':')), d[1])) for (var i = d[1].split(','), j = 0; j < i.length; j += 1) h.push(new r(d[0], i[j]));
    ...
    'function' == typeof define && define.amd
      ...
      ? (module.exports = mb)
      : ((window.WebFont = mb), window.WebFontConfig && lb.load(window.WebFontConfig));
  })();
var JFCustomWidgetUtils = (function () {
  ...
  function c(b) {
    ...
    return 'undefined' != typeof b && ~c && 0 === c && ((b = a(b)), (b = JFCustomWidget.getParentOrigin() + b)), b;
  }
  function d() {
  ...
  function h() {
    ...
    return (
      ...
      /ipad|android 3|sch-i800|playbook|tablet|kindle|gt-p1000|sgh-t849|shw-m180s|a510|a511|a100|dell streak|silk/i.test(a) ||
  ...
  function m(a, b) {
    if ('undefined' == typeof a || 'undefined' == typeof b || a === !1 || b === !1) return '';
    var c = {};
  ...
  function s(a, b) {
    var c = 5e3;
    'function' == typeof a ? ((c = !1), (b = a)) : 'number' == typeof a && (c = a), x && window.cancelAnimationFrame(x);
    var d = function () {
  ...
  function w(a, b, c) {
    ...
    if (
      ...
      d.onreadystatechange = function () {
        ('loaded' == d.readyState || 'complete' == d.readyState) && ((d.onreadystatechange = null), b && b());
      };
    else if (f() || g()) {
      (d = document.createElement('style')), (d.textContent = '@import "' + a + '"');
      ...
      d.addEventListener
        ...
        : 'isApplicationInstalled' in navigator && 'onloadcssdefined' in d && d.onloadcssdefined(b);
          ...
          for (
            b = e - 1,
              arguments.length > 1 &&
                ...
                b != b ? (b = 0) : 0 != b && b != 1 / 0 && b != -(1 / 0) && (b = (b > 0 || -1) * Math.floor(Math.abs(b)))),
      ...
      if (document.referrer && document.referrer.indexOf(a) > -1) {
        ...
        if (!d) {
          ...
          if (document.referrer.indexOf(b) > -1) {
            ...
            (e = 'https://' + h + '.jotform.pro/hackweek/theme/' + g + '/widget.css'),
              (f = 'https://' + h + '.jotform.pro/hackweek/theme/' + g + '/widget.js');
          } else
...
var JFWidgetTranslation = (function () {
    ...
    function b(a) {
      ...
      return (
        void 0 !== d
          ...
          : isNaN(a.innerText) && 0 !== a.innerText.length && '' !== a.innerText && b.push(a.innerText),
        b
      );
    }
    function c(a) {
          ...
          a.classList.contains('_uidset') === !1 &&
            (void 0 !== d
              ? d.forEach(function (b) {
                  var c = a[b];
                  'undefined' != typeof c && 0 !== c.length && '' !== c && isNaN(c) && f.push({ id: e, property: b, text: c });
                })
            ...
            0 !== f.length && ((b[e] = f), a.classList.add(e), a.classList.add('_uidset')));
        }),
    ...
    return (j.translate = e), (j.getTranslatables = a), (j.setDictionary = c), (j.getDictionary = d), (j.getTranslation = f), j;
  })(),
  JFCustomWidget = (function () {
    function a() {
      ...
      if (!eb[a]) return !1;
      for (var c = eb[a], d = c ? c.length : 0; d--; ) c[d].func(b[0]);
    }
    function b(a, b) {
      'submit' === a && void 0 !== eb[a] && eb[a].pop(), eb[a] || (eb[a] = []);
      var c = (++db).toString();
      return eb[a].push({ func: b, token: c }), c;
    }
    function c(a, c) {
      if (~a.indexOf(' ')) {
    ...
    function d(a) {
      for (var b in eb)
        for (var c = eb[b], d = 0; d < c.length; d++) {
          var e = c[d];
    ...
    function e(a) {
      return cb() ? !1 : ((a.type = 'data'), (a.qid = lb.questionID), N(a), void 0);
    }
    function f(a) {
      if (cb()) {
        var b = { type: 'translation', qid: lb.questionID, formID: lb.formID, data: a };
        N(b);
      }
    }
    function g(a) {
      return cb() ? !1 : ((a.type = 'submit'), (a.qid = lb.questionID), N(a), void 0);
    }
    function h() {
      var a = document.querySelectorAll('input'),
        b = document.querySelectorAll('select');
      a.forEach(function (a) {
        'radio' === a.type || 'checkbox' === a.type ? (a.checked = !1) : 'button' !== a.type && (a.value = '');
      }),
    ...
    function j(a) {
      (a.type = 'size'), (a.qid = lb.questionID), N(a);
    }
    function k(a) {
      N({ type: 'styles', qid: lb.questionID, styles: a || {} });
    }
    function l(a) {
      var b = P();
      N({ eventID: b, type: 'frame:move', qid: lb.questionID }), c('event:emitter:' + b, a);
    }
    function m(a) {
      var b = P();
      N({ type: 'frame:getdata', eventID: b, qid: lb.questionID }), c('event:emitter:' + b, a);
    }
    function n(a, b, e) {
      var f = 'undefined' != typeof e ? !0 : !1,
        g = P();
      if ((N({ eventID: g, type: 'event:store', field: a, value: b, qid: lb.questionID, hasCallback: f }), f))
        var h = c('event:emitter:' + g, function (a) {
          e(a.value), d(h);
        });
    }
    function o(a, b) {
      N({ type: 'fields:fill', fields: a, qid: lb.questionID, identifier: b || '' });
    }
    function p(a) {
      N({ type: 'fields:clear', fields: a, qid: lb.questionID });
    }
    function q(a, b, d) {
      var e = P();
      N({ fields: a, type: 'fields:capture', eventID: e, identifier: b, qid: lb.questionID }), c('event:emitter:' + e, d);
    }
    function r(a, b) {
      q(a, 'id', b);
    }
    ...
    function t(a) {
      var b = P();
      N({ type: 'form:trackerID', eventID: b, qid: lb.questionID }), c('event:emitter:' + b, a);
    }
    function u(a) {
      o(a, 'label');
    }
    ...
    function y(a, b) {
      'undefined' != typeof b &&
        c('event:emitter:' + lb.questionID, function (a) {
          b(a.value);
        });
    }
    function z() {
      var a = { type: 'submit:frame:remove', qid: lb.questionID };
      N(a);
    }
    function A(a, b) {
      return (
        'function' == typeof a ? (kb.callback = a) : B(a),
        'undefined' != typeof b && (kb.options = Object.assign({}, kb.options, b)),
        lb
      );
    }
    function B(a) {
      if (('string' == typeof a && (a = [a]), '[object Array]' !== Object.prototype.toString.call(a) && (a = []), a.length > 0))
        for (var b = 0; b < a.length; b++) kb.list.push(a[b]);
    }
    function C() {
      return kb.list.length > 0;
    }
    function D(a) {
      if ('function' == typeof kb.callback) {
        var b = kb.callback(S());
        B(b), (kb.callback = !1);
      }
      if (C()) {
        var c = 'parallel' in kb.options && !!kb.options.parallel;
        if ((c = c && kb.list.length > 1 ? !0 : !1))
          for (var d = [], e = 0; e < kb.list.length; e++) {
            var f = kb.list[e];
            JFCustomWidgetUtils.loadJS(f, function (b) {
              'function' == typeof kb.options.onLoad && kb.options.onLoad(b), d.push(b), d.length === kb.list.length && a && a();
            });
          }
        else {
          var f = kb.list.shift();
          JFCustomWidgetUtils.loadJS(f, function (b) {
            'function' == typeof kb.options.onLoad && kb.options.onLoad(b), D(a);
          });
        }
      } else a && a();
    }
    function E() {
      var a = { qid: lb.questionID, type: 'field:hide' };
      N(a);
    }
    function F() {
      var a = { qid: lb.questionID, type: 'field:show' };
      N(a);
    }
    function G(a) {
      var b = {
    ...
    function H(a, b) {
      return (
        N({ type: 'errors', qid: lb.questionID, action: 'show', msg: a, resetForm: b || !1 }),
        lb.sendSubmit({ valid: !1, value: '' }),
        lb
      );
    }
    function I() {
      return N({ type: 'errors', qid: lb.questionID, action: 'hide' }), lb;
    }
    function J() {
      N({ type: 'required', qid: lb.questionID, action: 'set' });
    }
    function K() {
      N({ type: 'required', qid: lb.questionID, action: 'unset' });
    }
    function L() {
      return ib;
    }
    function M() {
      return ib && 'cardform' in ib && ib.cardform === !0;
    }
    function N(a) {
      XD.postMessage(JSON.stringify(a), nb, parent);
    }
    function O(a, b) {
      null === b && (b = ''), (a = a.replace(/[\[]/, '\\[').replace(/[\]]/, '\\]'));
      var c = new RegExp('[\\?&]' + a + '=([^&#]*)'),
      ...
      var c,
        d = function (a, b) {
          return (
            ...
            b < a.length ? a.slice(a.length - b) : b > a.length ? Array(1 + (b - a.length)).join('0') + a : a
          );
        };
      return (
    ...
    function S() {
      if (!gb) return Q();
      for (var a = JSON.parse(decodeURIComponent(gb)), b = {}, c = 0; c < a.length; c++) {
        var d = a[c],
          e = JFCustomWidgetUtils.isJsonString(d.value) ? JSON.parse(d.value) : d.value;
    ...
    function V(a, b, c) {
      if (a && b)
        try {
          ...
          if (!d) {
            var e = '92891840837975' === a ? 'https://aysenur.jotform.pro' : 'https://cdn.jotfor.ms',
              f = e + '/stylebuilder/' + a + '.widgets.' + b + '.css',
              g = window.location.search.split('?').join(''),
              h = g.indexOf('offline_forms=true') > -1 || g.indexOf('offline_forms=si') > -1,
              i = window && window.location && window.location.href && 0 === window.location.href.indexOf('file://'),
            ...
            h && !j && i
              ...
              : JFCustomWidgetUtils.loadCSS(
                  f,
                  function () {
                    c && c(), lb.publish('cardform:widgetcss:active');
                  },
          ...
          var k = 'cardFormWidget_' + b,
            l = 'card-form-widget';
          'object' == typeof document.body.classList && 'function' == typeof document.body.classList.contains
            ? document.body.classList.contains(k) || (document.body.classList.add(k), document.body.classList.add(l))
            : 'string' == typeof documeny.body.className &&
              -1 === document.body.className.indexOf(k) &&
              ((document.body.className += ' ' + k), (document.body.className += ' ' + l));
        } catch (m) {
          console.error(m);
        }
    }
    function W() {
      function a() {
        ...
        if ((document.querySelector('body') && document.querySelector('body').setAttribute('data-theme', 'upcoming'), !a)) {
      ...
      try {
        ...
        (document.referrer.indexOf(f) > -1 || h > -1 || (g && c.indexOf(g) > -1)) && a(),
    ...
    function X() {
      lb.subscribe('ready', function () {
        document.body.style.background = 'transparent';
      }),
        lb.subscribe('submit', function () {
          lb.sendSubmit({ initial: !0, data: !1, valid: !0 });
        }),
        lb.subscribe('style', function (a) {
          if (void 0 !== a.font) {
            var b = a.font.family;
            Z(b);
          }
        }),
        lb.subscribe('clear', lb.clearWidgetFields);
    }
    function Y() {
      var a = _(R('customCSS'));
    ...
    function Z(a) {
      ...
      if (((a = a.split(',')[0]), b.indexOf(a) >= 0))
        (document.body.style.fontFamily = '"' + a + '", sans-serif'),
          lb.publish('customfont:active', a),
          lb.publish('customfont', a);
      else {
        document.body.style.fontFamily = '"' + a + '", sans-serif';
        ...
        WebFont.load({
          ...
          active: function () {
            lb.publish('customfont:active', a), lb.publish('customfont', a);
          },
        });
      }
    }
    ...
    function _(a) {
      ...
      return (
        a &&
          'string' == typeof a &&
          ((a = escape(a).replace(/%26/g, '&').replace(/%23/g, '#').replace(/%3B/g, ';')),
          (b.innerHTML = a),
          b.innerText ? ((a = b.innerText), (b.innerText = '')) : ((a = b.textContent), (b.textContent = ''))),
        unescape(a)
      );
    }
    function ab() {
      var a = !1;
      return 'required' in ib && (a = ib.required), a;
    }
    function bb() {
      return 'static' in ib ? ib.static : !1;
    }
    function cb() {
      var a = !1;
      return 'onWizard' in ib && (a = ib.onWizard), a;
    }
    var db = -1,
      eb = {},
      fb = !1,
      ...
      ib = {},
      jb = !1,
      kb = { callback: !1, list: [], options: { parallel: !1, onLoad: function () {} } },
      lb = { texts: {}, formID: -1, questionID: O('qid') };
    (lb.publish = a),
      (lb.subscribe = c),
      (lb.on = c),
      (lb.unsubscribe = d),
      (lb.off = d),
      (lb.sendData = e),
      (lb.sendTranslatables = f),
      (lb.sendSubmit = g),
      (lb.clearWidgetFields = h),
      (lb.sendReady = i),
      (lb.requestFrameResize = j),
      (lb.setFrameSize = j),
      (lb.setFrameStyles = k),
      (lb.detectFrameMovement = l),
      (lb.hideWidgetContainer = E),
      (lb.showWidgetContainer = F),
      (lb.replaceWidget = G),
      (lb.getWidgetData = L),
      (lb.getFrameData = m),
      (lb.isFromCardform = M),
      (lb.setupLibraries = A),
      (lb.removeSubmittedFrame = z),
      (lb.showWidgetError = H),
      (lb.hideWidgetError = I),
      (lb.makeWidgetRequired = J),
      (lb.makeWidgetNotRequired = K),
      (lb.listenFromField = x),
      (lb.listenFromWidget = y),
      (lb.storeToField = n),
      (lb.setFieldsValueByLabel = u),
      (lb.setFieldsValueById = v),
      (lb.clearFields = p),
      (lb.getFieldsValueById = r),
      (lb.getFieldsValueByName = s),
      (lb.getFormTrackerID = t),
      (lb.getQueryString = R),
      (lb.getAllQueryString = S),
      (lb.getWidgetSetting = R),
      (lb.getWidgetSettings = S),
      (lb.getParentOrigin = T),
      (lb.getEnterprise = U),
      (lb.isWidgetRequired = ab),
      (lb.isWidgetStatic = bb),
      (lb.isWidgetOnBuilder = cb);
    var mb = O('ref'),
      nb = decodeURIComponent(mb);
    if ((!mb || 'undefined' == typeof mb) && 'undefined' == typeof O('qid')) {
      var ob = document.location.hash.replace(/^#/, ''),
        pb = ob.lastIndexOf('/');
      (nb = decodeURIComponent(ob.substr(0, pb))), (lb.questionID = Number(ob.substr(pb + 1)));
    }
    return (
      XD.receiveMessage(function (a) {
        if (!('data' in a && a.data.indexOf('/*framebus*/') > -1)) {
          ...
          switch (b.type) {
            case 'ready':
              if (fb) return !1;
              b.fontFamily && b.fontFamily.length > 0 && Z(b.fontFamily),
                b.enterprise && (jb = b.enterprise),
                b.settings && !gb && ((gb = b.settings), delete b.settings),
                'origin' in b && ((hb = b.origin), delete b.origin),
                Y(),
                (fb = !0),
                (ib = b),
              ...
              break;
            case 'settings':
              b.settings && !gb && (gb = b.settings);
              break;
            case 'event:receiver':
              'isWidget' in b && b.isWidget
                ? lb.publish('event:emitter:' + b.targetQID, b)
                : lb.publish('event:emitter:' + b.eventID, b);
              break;
            case 'formstrings':
              'formTexts' in b && $(lb.texts) < 1 && (lb.texts = b.formTexts);
              break;
            case 'widgetclear':
              lb.publish('clear', b);
              break;
            case 'widgetpopulate':
              lb.publish('populate', b);
              break;
            case 'widgetshift':
              lb.publish('shift', b);
              break;
            ...
            case 'submit':
              var c = !1;
              'method' in b && 'next' === b.method && ((c = !0), lb.publish('next')), lb.publish('submit', c);
              break;
            case 'style':
              lb.publish('style', b);
              break;
            case 'frameresize':
              lb.publish('frameresize', b);
              break;
            case 'translatable':
              (lb.formID = b.formID), lb.publish('translatable', b);
              break;
            case 'translate':
              lb.publish('translate', b);
          }
        }
      }, nb),
      X(),
